...
# Não é necessário repetir a configuração de banco já que ela foi passada como variável no docker-compose
# e na pipeline test.sh, porém alem de demonstrar que pode ser adicionado aqui, isso garante que jamais iremos apagar 
# um banco que não seja o de teste por engano.
